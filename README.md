...
5. All logical blocks on pages should be implemented as separate classes (please read about aggregation and composition)
...
1. Go to the https://demo.prestashop.com/
2. Check that 49 langueges exists in 'Language' dropdown in the top menu
